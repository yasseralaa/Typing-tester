...
namespace Typing_Tester
{
    ...
    sealed partial class App : Application
    {
        ...
        void OnCommandsRequested(SettingsPane sender, SettingsPaneCommandsRequestedEventArgs args)
        {
            ...
            //var about = new SettingsCommand(" bout", "About", (handler) =>
            //{
            ...
            //var Policy = new SettingsCommand("privace policy", "privacy policy", (handler) =>
            //{
            //    var settings = new SettingsFlyout();
            ...
            //var description = new SettingsCommand("privace policy", "privacy policy", (handler) =>
            //{
            //    var settings = new SettingsFlyout();
            //    settings.Content = new description();
            ...
            //args.Request.ApplicationCommands.Add(description);
            //args.Request.ApplicationCommands.Add(about);
            //args.Request.ApplicationCommands.Add(Policy);
        }
        ...
        //    Uri targetUri = new Uri(@"https://www.facebook.com/95yasseralaa");
        //}

        //// Method to launch the url of the privacy policy
        //async void LaunchPrivacyPolicyUrl()
        //{
        //    Uri privacyPolicyUrl = new Uri("https://www.facebook.com/95yasseralaa");
