...
namespace Typing_Tester
{
    ...
    /// </summary>
    public sealed partial class advancedtest1 : Page
    {
        ...
        {
            this.Frame.Navigate(typeof(advancedtest2));
        }
        ...
        async void timer_Tick(object sender, object e)
        {
            ...
            if (ticks <= 0)
            {
                ...
                msgDialog.Commands.Add(
                  new UICommand("level 2", new UICommandInvokedHandler((cmd) => result = 1)));
                msgDialog.Commands.Add(
        ...
        public void txtWrite_KeyUp(object sender, KeyRoutedEventArgs e)
        {
            if (e.Key == Windows.System.VirtualKey.Space)
            {
                txtWrite.Text = string.Empty;
