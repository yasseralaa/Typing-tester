...
namespace Typing_Tester
{
    ...
    /// </summary>
    public sealed partial class advancedtest6 : Page
    {
        ...
        {
            this.Frame.Navigate(typeof(advancedtest7));
        }
        ...
        async void timer_Tick(object sender, object e)
        {
            ...
            if (ticks <= 0)
            {
                ...
                msgDialog.Commands.Add(
                  new UICommand("level 7", new UICommandInvokedHandler((cmd) => result = 1)));
                msgDialog.Commands.Add(
